...
public class PrintHandler extends SimpleChannelInboundHandler<ByteBuf> {
    ...
    public void channelActive(@NotNull ChannelHandlerContext ctx) throws Exception {
        log.info("ChannelActive    {}", JSON.toJSONString(CtxUtils.getRemoteAddress(ctx)));
    }
    ...
    public void channelInactive(@NotNull ChannelHandlerContext ctx) throws Exception {
        log.info("ChannelInActive  {}", JSON.toJSONString(CtxUtils.getRemoteAddress(ctx)));
    }
    ...
    public void exceptionCaught(ChannelHandlerContext ctx, Throwable cause) throws Exception {
        log.error("ExceptionCaught  |{}|{}", JSON.toJSONString(CtxUtils.getRemoteAddress(ctx)), cause.getMessage());
    }
